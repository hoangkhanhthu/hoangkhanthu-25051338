...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    meta: [
      ...
      { property: "og:title", content: "Portfolio Kỹ thuật số – Hoàng Khánh Thư" },
      { property: "og:description", content: "Hành trình học tập, sản phẩm và năng lực số qua 6 dự án ứng dụng AI có trách nhiệm." },
